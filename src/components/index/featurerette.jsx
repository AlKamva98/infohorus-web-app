...
export function Featurerette (){
 return(
  ...
  <Row>
    <Col className="order-md-2 col-md-8 mt-5 pt-4 my-auto text-white featurette">
    ...
    <Col className="order-md-1 col-md-4 d-flex justify-content-center text-center px-0 featurette">
      <Image className="img-fluid w-100" src="./images/jumbobg.png"    focusable="false"/>
    </Col>
  </Row>
  </div>
 )
