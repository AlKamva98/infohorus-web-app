...
function Employees(){
 ...
 const showLogs2 = (e) => {
  ...
  return (<>
    {hasData  && (<><Container>
<h4 className="text-center display-4">Employees list</h4>
<span>Click on the customer to assign tasks</span>
    ...
    <Link to= {{pathname: "/dash/assess" ,state: checkbox1}}><Button className= "ml-5 mb-5"  type="submit">Assign</Button></Link>
   <div>
