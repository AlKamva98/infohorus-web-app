...
const AppContent = (props) => {
    const {approve, approved,deleteMember,updateMember,handleMemberAdd, recommendations, errModal, errToggle, revToggle, revModal,handleCreateQuestionnaire, msg, rec,toggle,modal, setMessages, setRec,teamTable,addTask, tasks, news, continueAss, events, userDetails,hasQuestionnaire, questionnaire, messages }= props;
