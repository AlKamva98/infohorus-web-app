...
<Carousel infiniteLoop={true} interval={12000} autoPlay={true} className = "w-full bg-gray-500 mx-auto ">
  <div  className="flex flex-wrap items-center bg-cover bg-no-repeat bg-center bg-slide-one w-full mx-auto "> 
    <div className="w-1/2 mx-auto mt-40 mb-40 pt-3 pb-3 pr-3 pl-3 bg-white rounded-md ">
 ...
 <div className="w-1/2 mx-auto mt-48 mb-48 pt-3 pb-3 pr-3 pl-3 bg-white rounded-md ">
