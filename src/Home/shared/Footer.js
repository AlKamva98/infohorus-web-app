...
{/*             
            ...
            <div className="px-5 py-2">
              <Link to="/terms" target="_blank" rel="noreferrer"  className="text-base leading-6 text-gray-500 hover:text-gray-900">
                Terms of Use
              </Link>
            </div>
            </ul>
          ...
          <div className="flex justify-center mt-8 space-x-6">
            ...
            <a href="https://www.instagram.com/bahatitech/"  target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gray-500">
            ...
            <a href="https://twitter.com/bahati_tech/" target="_blank" rel="noreferrer" className="text-gray-400 hover:text-gray-500">
