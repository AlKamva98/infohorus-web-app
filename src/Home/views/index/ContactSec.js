...
function ContactSec(props) {
    return (
        <div className='bg-cyan-900 '>
            ...
            <Link to="/main/contact" className='flex items-center w-full btn px-6 py-3 mb-3 text-lg text-white bg-gray-900 rounded-full sm:mb-0 hover:bg-gray-700 sm:w-auto'>Send Message</Link>
            </div>
        </div>
    );
}
